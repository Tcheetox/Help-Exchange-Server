...
Doorkeeper.configure do
  ...
  # Tell Doorkeeper we are using user credentials to login
  ...
  # User won’t get redirected after login, as we are using API
  ...
  # Enable refresh token mechanism in OAuth, you can insert the use_refresh_token into the configuration.
  # This would allow the client app to request a new access token using the refresh token when the current access token is expired
  use_refresh_token
  ...
  #refresh_token_expires_in 15.minutes
  ...
  before_successful_authorization do |controller, context|
    ...
    if (controller.request.params[:grant_type] == 'refresh_token')
      access_token = Doorkeeper::AccessToken.find_by(refresh_token: controller.request.params[:refresh_token])
